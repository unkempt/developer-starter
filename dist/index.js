...
(() => {
  ...
  // node_modules/.pnpm/wheel-indicator@1.3.0/node_modules/wheel-indicator/lib/wheel-indicator.js
  var require_wheel_indicator = __commonJS({
    "node_modules/.pnpm/wheel-indicator@1.3.0/node_modules/wheel-indicator/lib/wheel-indicator.js"(exports, module) {
      init_live_reload();
      var WheelIndicator2 = function() {
        function Module(options) {
          ...
          this._options = extend3(DEFAULTS, options);
          ...
          var self = this;
          this._wheelHandler = function(event2) {
            if (self._isWorking) {
              processDelta.call(self, event2);
        ...
        Module.prototype = {
          ...
          setOptions: function(options) {
            this._options = extend3(this._options, options);
            return this;
          },
          getOption: function(option) {
            var neededOption = this._options[option];
            if (neededOption !== void 0) {
              return neededOption;
            }
        ...
        function triggerEvent(event2) {
          event2.direction = this._direction;
          this._options.callback(event2);
        }
        var getDeltaY = function(event2) {
          if (event2.wheelDelta && !event2.deltaY) {
            getDeltaY = function(event3) {
              return event3.wheelDelta * -1;
            };
          } else {
            getDeltaY = function(event3) {
              return event3.deltaY;
            };
          }
          return getDeltaY(event2);
        };
        ...
        function processDelta(event2) {
          var self = this, delta = getDeltaY(event2);
          if (delta === 0)
            return;
          var direction = delta > 0 ? "down" : "up", arrayLength = self._deltaArray.length, changedDirection = false, repeatDirection = 0, sustainableDirection, i;
          ...
          if (!self._isStopped) {
            if (changedDirection) {
              ...
              triggerEvent.call(this, event2);
            } else {
              if (Math.abs(repeatDirection) === arrayLength) {
                analyzeArray.call(this, event2);
              }
            }
          }
          if (self._isStopped) {
        ...
        function analyzeArray(event2) {
          var deltaArray0Abs = Math.abs(this._deltaArray[0]), deltaArray1Abs = Math.abs(this._deltaArray[1]), deltaArray2Abs = Math.abs(this._deltaArray[2]), deltaAbs = Math.abs(getDeltaY(event2));
        ...
        function extend3(defaults2, options) {
          var extended = {}, prop;
          for (prop in defaults2) {
            if (Object.prototype.hasOwnProperty.call(defaults2, prop)) {
      ...
      if (typeof exports === "object") {
        module.exports = WheelIndicator2;
      }
  ...
  // node_modules/.pnpm/swiper@11.1.1/node_modules/swiper/swiper.mjs
  init_live_reload();
  ...
  // node_modules/.pnpm/swiper@11.1.1/node_modules/swiper/modules/index.mjs
  init_live_reload();
  ...
  // src/index.ts
  var import_wheel_indicator = __toESM(require_wheel_indicator(), 1);
  ...
  document.addEventListener(
    ...
    function() {
      ...
      const indicator = new import_wheel_indicator.default({
